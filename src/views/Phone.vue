        ...
        <section v-if="!loading">
            <div class="container">
                ...
                <div class="row" id="table_container">
                    <div class="col-12">
                        <div v-if="paginatedPhones.length > 0">
                            <table>
                                <tbody v-for="(phone, index) in paginatedPhones" :key="index">
...
export default {
    ...
    methods: {
        ...
        createPhone() {
            ...
            axios.post(`${apiBaseUrl}/api/phone/${apartmentIdData.Apartment_ID}/`, phoneData)
                .then(response => {
